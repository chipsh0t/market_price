...
class Product:
    ...
    def todict(self):
        return {"id":self.name,"productURL":self.link,"imageURL":self.img,"name":self.name,"price":self.price}
...
if __name__ == '__main__':
    scraper = Scraper(
        100, "https://www.mymarket.ge/ka/search/1064/iyideba-teqnika/?CatID=1064&Page=1")
